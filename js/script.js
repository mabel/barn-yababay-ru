(function($){
  Vue.component('youtube', {
     props: ['vid'], 
     template: '<div class="youtube-container"> <iframe :src="vid" frameborder="0" allowfullscreen class="youtube-video"></iframe> </div>'
  })
  Vue.component('img-local-remote', {
     props: ['local', 'remote'], 
  ...
  $('youtube, img-local-remote').each(function(){
